param(
    [string]$ContainerName = "dw_dash_descontos",
    [switch]$Json
)
...
$localValidator = Join-Path $scriptDir "validate_dash_descontos_filters.py"
$containerValidator = "/tmp/validate_dash_descontos_filters.py"
