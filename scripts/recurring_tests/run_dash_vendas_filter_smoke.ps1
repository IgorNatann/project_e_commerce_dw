param(
    [string]$ContainerName = "dw_dash_vendas",
    [switch]$Json
)
...
$localValidator = Join-Path $scriptDir "validate_dash_vendas_filters.py"
$containerValidator = "/tmp/validate_dash_vendas_filters.py"
...
# Limpeza best-effort para nao acumular artefato no container.
try {
