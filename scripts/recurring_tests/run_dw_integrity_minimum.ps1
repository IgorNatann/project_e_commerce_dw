param(
    [string]$ContainerName = "dw_etl_monitor",
    [switch]$Json
)
...
$localValidator = Join-Path $scriptDir "validate_dw_integrity_minimum.py"
$containerValidator = "/tmp/validate_dw_integrity_minimum.py"
