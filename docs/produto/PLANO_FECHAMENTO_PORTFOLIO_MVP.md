...
- [ ] Criar app Streamlit de metas/atingimento em `dashboards/streamlit/metas`.
- [ ] Criar README operacional do dashboard de metas.
- [ ] Adicionar build/deploy no Docker (novo servico).
- [ ] Publicar query SQL de referencia dos KPIs de metas.
