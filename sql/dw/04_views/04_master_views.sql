...
-- ========================================
PRINT '1/13 Executando: 01_vw_calendario_completo.sql';
:r .\01_vw_calendario_completo.sql
PRINT '';

PRINT '2/13 Executando: 02_vw_produtos_ativos.sql';
:r .\02_vw_produtos_ativos.sql
PRINT '';

PRINT '3/13 Executando: 03_vw_hierarquia_geografica.sql';
:r .\03_vw_hierarquia_geografica.sql
PRINT '';

PRINT '4/13 Executando: 05_vw_descontos_ativos.sql';
:r .\05_vw_descontos_ativos.sql
PRINT '';

PRINT '5/13 Executando: 06_vw_vendedores_ativos.sql';
:r .\06_vw_vendedores_ativos.sql
PRINT '';

PRINT '6/13 Executando: 07_vw_hierarquia_vendedores.sql';
...
-- 2. Views de equipes
-- ========================================
PRINT '7/13 Executando: 08_dw_analise_equipe_vendedores.sql';
:r .\08_dw_analise_equipe_vendedores.sql
PRINT '';

PRINT '8/13 Executando: 09_vw_equipes_ativas.sql';
:r .\09_vw_equipes_ativas.sql
PRINT '';

PRINT '9/13 Executando: 10_vw_ranking_equipes_meta.sql';
:r .\10_vw_ranking_equipes_meta.sql
PRINT '';

PRINT '10/13 Executando: 11_vw_analise_regional_equipes.sql';
:r .\11_vw_analise_regional_equipes.sql
PRINT '';

-- ========================================
-- 3. Views de consumo para dashboards
-- ========================================
PRINT '11/13 Executando: 12_vw_dash_vendas_r1.sql';
:r .\12_vw_dash_vendas_r1.sql
PRINT '';

PRINT '12/13 Executando: 13_vw_dash_metas_r1.sql';
:r .\13_vw_dash_metas_r1.sql
PRINT '';

PRINT '13/13 Executando: 14_vw_dash_descontos_r1.sql';
:r .\14_vw_dash_descontos_r1.sql
PRINT '';
...
;WITH expected_views AS (
    ...
    SELECT 'fact', 'VW_DASH_METAS_R1' UNION ALL
    SELECT 'fact', 'VW_DASH_DESCONTOS_R1'
)
SELECT
    ev.schema_name,
    ev.view_name,
